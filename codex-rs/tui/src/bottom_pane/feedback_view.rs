...
pub(crate) fn feedback_upload_consent_params(
    ...
    super::SelectionViewParams {
        ...
        items: vec![
            super::SelectionItem {
                name: "是".to_string(),
                description: Some("将当前 Codex 会话日志分享给团队，以便排查问题。".to_string()),
