...
function Get-ReleaseUrl {
    ...
    return "https://github.com/wintsa123/codex-cn/releases/download/rust-v$ResolvedVersion/$AssetName"
}
...
function Resolve-Version {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/wintsa123/codex-cn/releases/latest"
...
if ([string]::IsNullOrWhiteSpace($env:CODEX_INSTALL_DIR)) {
    $installDir = Join-Path $env:LOCALAPPDATA "Programs\Wintsa\CondexCn\bin"
} else {
